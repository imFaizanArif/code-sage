...
const SettingsModal = ({ setSettings, settings }: { setSettings: Function, settings: any }) => {
        ...
        <div className='relative text-white z-50'>
            <div aria-modal='true' role='dialog' className='fixed inset-0 overflow-y-auto z-modal'>
                <div className='flex min-h-screen items-center justify-center px-4'>
                    ...
                    <div className='my-8 inline-block min-w-full transform rounded-[13px] text-left transition-all bg-overlay-3 md:min-w-[420px] shadow-level4 shadow-lg p-0 bg-background w-[600px] !overflow-visible opacity-100 scale-100'>
                        {/* setting header */}
