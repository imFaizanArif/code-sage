...
const EditorFooter = ({ handleSubmit }: { handleSubmit: any }) => {
    // console.log(handleSubmit, "cccccccccccccccccccccc")
    return (
        <div className='flex bg-dark-layer-1 absolute bottom-10 z-10 w-full'>
            <div className='mx-5 my-3 mb-6 flex justify-between w-full'>
