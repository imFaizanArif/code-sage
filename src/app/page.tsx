  ...
  return (
    <div className='bg-background h-screen'>
      ...
      <div className='relative z-50 container mx-auto w-[70%] pt-32 text-center'>
        ...
        <h1 className='text-primary text-9xl'> Welcome to the
          <span className='bg-gradient-to-r from-stext to-etext text-transparent bg-clip-text text-9xl'> Code Sage</span>
        </h1>
